 ...
 * @ 10:22 PM
 */
public class SniffListenerClientUseEntity extends PacketAdapter {

    private final PacketSniffManager manager;

    public SniffListenerClientUseEntity(PacketSniffManager manager) {
        super(Papaya.getInstance(), PacketType.Play.Client.USE_ENTITY);
