 ...
 * @ 10:22 PM
 */
public class SniffListenerClientOnGround extends PacketAdapter {

    private final PacketSniffManager manager;

    public SniffListenerClientOnGround(PacketSniffManager manager) {
        super(Papaya.getInstance(), PacketType.Play.Client.FLYING);
