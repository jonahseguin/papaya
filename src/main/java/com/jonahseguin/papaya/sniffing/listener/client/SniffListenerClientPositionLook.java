 ...
 * @ 10:22 PM
 */
public class SniffListenerClientPositionLook extends PacketAdapter {

    private final PacketSniffManager manager;

    public SniffListenerClientPositionLook(PacketSniffManager manager) {
        super(Papaya.getInstance(), PacketType.Play.Client.POSITION_LOOK);
