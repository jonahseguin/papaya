 ...
 * @ 10:22 PM
 */
public class SniffListenerClientLook extends PacketAdapter {

    private final PacketSniffManager manager;

    public SniffListenerClientLook(PacketSniffManager manager) {
        super(Papaya.getInstance(), PacketType.Play.Client.LOOK);
